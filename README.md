...
https://github.com/user-attachments/assets/6a9912d0-10bd-4fa6-897d-047c40e0a0e4
...
TrackWeight utilizes a custom fork of the [Open Multi-Touch Support library](https://github.com/Kyome22/OpenMultitouchSupport) by [Takuto Nakamura](https://github.com/Kyome22) to gain private access to all mouse and trackpad events on macOS. This library provides detailed touch data including pressure readings that are normally inaccessible to standard applications.
...
1. Download the latest TrackWeight DMG file
2. Open the DMG and drag TrackWeight.app to your Applications folder
3. Run the application (you may need to allow it in System Preferences > Security & Privacy for unsigned builds)

### Option 2: Homebrew
```bash
brew install --cask shanmuckh/apps/trackweight --force
```
